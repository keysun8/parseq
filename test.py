...
def main():
    ...
    test_set = ['real_val' , 'uc_test' , 'uc_val' , 'syn_data_3_val' , 'real_train' ]  # Custom evaluation set
    # test_set = ['syn_2_merged']
    results = {}
    ...
    result_groups = {
        'Custom Evaluation': ['real_val', 'uc_test' , 'uc_val' , 'syn_data_3_val','real_train' ],
        # 'Custom Evaluation': ['syn_2_merged'],
    }
